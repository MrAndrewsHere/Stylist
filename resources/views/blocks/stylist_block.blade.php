              ...
              <form class="admin-request__accept_form" style="margin: auto;height: 100px">
                  ...
                  <div class="form__output" style="text-align: center">
                      ...
                      <div class="form__output" style="text-align: center">
                          ...
                          <div class="col-md-6 mb-3">
                              <button disabled class="btn btn--action btn--action-buy" id="reset-btn" style="margin: auto; background-color:white; color: black;box-shadow: 0 0px 2px 1px rgba(164,0,116,0.5)" type="button">Отключить</button>

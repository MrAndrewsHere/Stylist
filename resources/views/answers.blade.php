      ...
      <div class="container">
        <div class="ask-question__quests">
          <div class="ask-question__quest">
            ...
            <div class="ask-question__quest-block">
              <h2 class="ask-question__quest-block-title">
                Подскажите, стилист может сам назначать себе категорию?<br> Если да, то каким образом, если нет, то кто это делает?
          ...
          <div class="ask-question__quest">
            ...
            <div class="ask-question__quest-block">
              <h2 class="ask-question__quest-block-title">
                Я стилист с большим стажем. <br>Как много я могу загружать документов, подтверждающих мой статус?
              </h2>
              <div class="ask-question__quest-block-text">

    ...
    <div class="container">
      <div class="card card__margin">
        ...
        <div class="card__description card__description--services">
          ...
          <div class="card__description__text">Встреча с личным стилистом, в процессе которой стилист определит ваш
            цветотиптип фигуры, вы получите рекомендации по подбору одежды и советы по стилю.Имидж-консультация может

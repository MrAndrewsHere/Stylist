        ...
        <section class="section section--lk-stylist section__home">
            <div class="container-lk">
                ...
                {{csrf_field()}}
                    ...
                    <label>Заголовок
                        <input name="title" class="form__input" type="text" required="required"/>
                    </label>

                    <label>Slug
                        <input name="slug" class="form__input" type="text" required="required"/>
                    </label>

                    <label>Текст
                        <input name="content" class="form__input" type="text" required="required"/>
                    </label>

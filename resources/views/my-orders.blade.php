...
@section('content')
  ...
  <section class="section section--my-orders section__home">
    ...
    <div class="container-home">
      <div class="my-orders">
        <div class="my-orders__status"><a class="link-tab link-active" href="#">Новые заказы</a><a class="link-tab" href="#">История заказов</a></div>
        <div class="my-orders__item my-orders__item--active">
          <div class="scroll-block scroll-block--orders scroll-block--slim scroll-block__wrapper">
            <ul class="orders__title">
              <li class="orders__photo">Фото</li>
            ...
            <ul class="orders__item">
              <li class="orders__photo"><img src="img/services/selection-hairstyle.png" alt="" width="70%"/></li>
              <li class="orders__service orders__service--big"><span>Подбор прически</span><br/><span>Стилист первой категории</span></li>
              <li class="orders__count orders__count--big">
                <div class="orders__count-change">
                  <button class="btn btn--count minus">-</button>
                  <input class="input--number input-count" type="number" min="1" max="10" value="2"/>
            ...
            <ul class="orders__item">
              ...
              <li class="orders__service orders__service--big"><span>Подбор макияжа</span><br/><span>VIP стилист</span></li>
              <li class="orders__count orders__count--big">
                <div class="orders__count-change">
                  <button class="btn btn--count minus">-</button>
                  <input class="input--number input-count" type="number" min="1" max="10" value="1"/>
                  <button class="btn btn--count plus">+</button>
                </div>
              </li>
              <li class="orders__price orders__price--big">
            ...
            <ul class="orders__item">
              ...
              <li class="orders__service orders__service--big"><span>Пакет или подарочный сертификат make over</span><br/><span>VIP стилист</span></li>
              <li class="orders__count orders__count--big">
                <div class="orders__count-change">
                  <button class="btn btn--count minus">-</button>
                  <input class="input--number input-count" type="number" min="1" max="10" value="1"/>
        ...
        <div class="my-orders__item">
          <div class="scroll-block scroll-block--orders scroll-block--slim scroll-block__wrapper">
            ...
            <ul class="orders__item">
              <li class="orders__photo"><img src="img/services/selection-hairstyle.png" alt="" width="70%"/></li>
              <li class="orders__service orders__service--big"><span>Подбор прически</span><br/><span>Стилист первой категории</span><br/><a class="common-link" href="#">Стилевое решение</a></li>
            ...
            <ul class="orders__item">
              ...
              <li class="orders__service orders__service--big"><span>Подбор макияжа</span><br/><span>VIP стилист</span><br/><a class="common-link" href="#">Стилевое решение</a></li>
            ...
            <ul class="orders__item">
              <li class="orders__photo"><img src="img/services/make-over.png" alt="" width="70%"/></li>
              <li class="orders__service orders__service--big"><span>Пакет или подарочный сертификат make over</span><br/><a class="common-link" href="#">Стилевое решение</a></li>

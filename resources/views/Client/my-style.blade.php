          ...
          <div class="lk-client__style">
            ...
            <div class="lk-client__style-seasons">
              ...
              <div class="lk-client__style-seasons-description">
                ...
                <p class="lk-client__style-seasons-description-text">Продолжением цвето</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="lk-client__style">
            ...
            <div class="lk-client__style-seasons">
              <div class="lk-client__style-body-type">
                <h3>Груша</h3>
                <p class="lk-client__style-seasons-description-text">Груша — тип фигуры, который среди современных
            ...
            <div class="lk-client__style">
              ...
              <div class="lk-client__style-seasons">
                <div class="lk-client__style-tips">
                  <h3>Советы:</h3>
                  <p class="lk-client__style-seasons-description-text">Мешковатые изделия лучше не носить, так как они
                  ...
                  <p class="lk-client__style-seasons-description-text">Для того чтобы его поддержать, лучше брать такие
                  ...
                  <p class="lk-client__style-seasons-description-text">Чаще всего она становится прямоугольником. На
                    бедрах акценты ставить не стоит. Подбирая топы и блузки для фигуры типа песочные часы, не нужно
